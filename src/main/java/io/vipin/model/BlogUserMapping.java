...
public class BlogUserMapping implements Serializable {
	...
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="BLOGUSERMAPPING_SEQ")
	@SequenceGenerator(name="BLOGUSERMAPPING_SEQ", sequenceName="BLOGUSERMAPPING_SEQ", allocationSize=1)
