...
<div id="frame">
	<div id="sidepanel">
		<div id="profile">
			<div class="wrap">
				<img id="profile-img" src="../images/Vipin_sharma.jpeg" class="online" alt="" />
				<p>Alok Tyagi</p>
			...
			<ul>
				<li class="contact active">
					<div class="wrap">
						...
						<div class="meta">
							<p class="name">Vipin Sharma</p>
							<p class="preview">Wrong. You take the gun</p>
						</div>
					</div>
				</li>
			</ul>
...
$(".preview").click(function() {
	...
	var recieverid = "2";
	$.ajax({
		url : 'getAllChat?senderid=' + senderid+'&recieverid='+recieverid,
			type : 'GET',
			datatype : 'json',			
			success:function(data){		
			 	console.log(data)
			 		console.log(data[0].chatContent)
			 	newMessage(data[0].chatContent)
			},
...
function newMessage(message) {
	...
	$('<li class="sent"><img src="../images/Vipin_sharma.jpeg" alt="" /><p>' + message + '</p></li>').appendTo($('.messages ul'));
